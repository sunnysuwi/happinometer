...
const SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'department', text: '1.15 ท่านปฏิบัติงานในกลุ่ม/ฝ่าย/แผนก ใดในหน่วยงานของท่าน (เลือกกลุ่มงานตามโครงสร้างตามประเภทหน่วยงาน)', type: 'select', options: ['ER', 'OPD', 'Ward1', 'Ward2', 'OR', 'LR', 'คลินิกพิเศษ', 'supply', 'งานประกัน', 'ห้องlab+xray', 'บริหาร', 'PCU', 'กายภาพ', 'แผนไทย', 'จิตเวช', 'เภสัชกรรม'] }
    ]
  },
  {
